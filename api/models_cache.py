...
MODELS_CACHE: List[ModelInfo] = [
    ...
    ModelInfo(
        ...
        type="text",
        description="DeepSeek R1 0528 — latest reasoning model on OpenRouter free tier.",
    ...
    ModelInfo(
        ...
        type="text",
        description="Alibaba Cloud Qwen3 8B on OpenRouter free tier.",
        logo_url="/logos/openrouter.svg",
    ...
    ModelInfo(
        ...
        type="text",
        description="Google Gemma 3 lightweight model on OpenRouter free tier.",
        logo_url="/logos/openrouter.svg",
        context_length=8192,
        cost_per_1k_tokens=0.0,
        is_free=True,
